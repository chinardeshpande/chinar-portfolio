      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">{stats?.total_enquiries || 0}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">{stats?.new_enquiries || 0}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">{stats?.this_week || 0}</p>
          </div>
        </div>
