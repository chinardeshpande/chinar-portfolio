              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-base sm:text-lg text-gray-900 mb-1">Technology Leadership</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">30+ years as CIO, CTO and CEO across global organizations, leading digital transformation initiatives, and building disruptive products and markets.</p>
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-base sm:text-lg text-gray-900 mb-1">Robotics & AI</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">Leading robotics implementation globally with Autostore, Geek+, and T-sorters. Driving Business AI adoption and AI-driven eCommerce experience.</p>
                    <div className="flex flex-wrap gap-1 sm:gap-1.5">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-base sm:text-lg text-gray-900 mb-1">Global Operations & GCC Setup</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">Championing large-scale operations across 14 countries and 8 industries, serving 300+ global brands. Masterfully setting up new GCCs from scratch in India.</p>
                    <div className="flex flex-wrap gap-1 sm:gap-1.5">
