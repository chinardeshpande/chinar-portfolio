  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center min-h-[400px] sm:min-h-[500px]">
          {/* Content */}
          <div className="px-4 sm:px-6 lg:px-12 py-6 sm:py-8 lg:py-0 order-2 lg:order-1">
            <div className="max-w-xl">
              <div className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 bg-primary-100 text-primary-700 rounded-full text-xs sm:text-sm font-medium mb-2 sm:mb-3">
                Operator in the arena. Advisor in the room.
              </div>
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                {/* First Punchline */}
                <div className="bg-gradient-to-r from-primary-50 to-blue-50 border-l-4 border-primary-600 rounded-r-lg p-2 sm:p-3 shadow-sm">
                ...
                {/* Second Punchline */}
                <div className="bg-gradient-to-r from-blue-50 to-primary-50 border-l-4 border-blue-600 rounded-r-lg p-2 sm:p-3 shadow-sm">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="flex-shrink-0">
          ...
          <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] order-1 lg:order-2">
            ...
            <button
              ...
              className="hidden sm:flex absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 bg-white/90 hover:bg-white rounded-full shadow-lg items-center justify-center transition-all hover:scale-110"
            ...
            <button
              onClick={goToNext}
              className="hidden sm:flex absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 bg-white/90 hover:bg-white rounded-full shadow-lg items-center justify-center transition-all hover:scale-110"
